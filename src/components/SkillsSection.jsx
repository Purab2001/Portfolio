...
export const SkillsSection = () => {
  ...
  return (
    <section
      id="skills"
      className="section-modern bg-gradient-to-b from-background to-secondary/20 py-12 sm:py-16 md:py-24 px-4"
    >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 mb-12 sm:mb-16">
          {filteredSkills.map((skill, index) => (
            <div
              ...
              data-index={index}
              className={cn(
                "group relative card-modern p-4 sm:p-6 hover:scale-105 transition-all duration-500",
            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                <div className="relative">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary/10 rounded-lg sm:rounded-xl flex items-center justify-center group-hover:bg-primary/20 transition-colors duration-300">
                ...
                <div className="flex-1 flex items-center">
                  <h3 className="font-bold text-base sm:text-lg group-hover:text-primary transition-colors duration-300">
                    {skill.name}
                  </h3>
                </div>
              </div>
