...
window.PORTFOLIO_DATA = {
  skills: [
    ...
    { id: "mongodb", name: "React", level: 70, category: "backend", icon: "assets/mongoDB.svg" },
    { id: "axios", name: "Axios", level: 75, category: "backend", icon: "SiAxios" },
    { id: "stripe", name: "Stripe", level: 80, category: "backend", icon: "SiStripe" },
    ...
    { id: "docker", name: "Docker", level: 70, category: "tools", icon: "SiDocker" },
